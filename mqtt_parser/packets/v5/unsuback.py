...
class UnsubackVariableHeader(MQTTVariableHeader):
    ...
    @classmethod
    def from_args(cls, packet_identifier: int, properties: list[Property]):
...
class UnsubackPacket(Packet):
    ...
    @classmethod
    def from_args(cls, packet_identifier: int, properties: list[Property], reason_codes: list[int]):
        variable_header = UnsubackVariableHeader.from_args(packet_identifier, properties)
