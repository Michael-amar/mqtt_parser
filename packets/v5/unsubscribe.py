...
class UnsubscribePacket(Packet):
    ...
    @classmethod
    def from_args(cls, packet_identifier : int, properties : list[Property], topics : list[str]):
        variable_header = UnsubscribeVariableHeader.from_args(packet_identifier, properties)
